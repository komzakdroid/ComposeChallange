package com.komzak.myapplication.di.networkModule

import android.app.Application
import com.chuckerteam.chucker.api.ChuckerInterceptor
import com.komzak.myapplication.data.source.remote.RequestInterceptor
...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideMainService(retrofit: Retrofit): MovieApiService =
